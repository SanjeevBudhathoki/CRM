...
urlpatterns = [
    ...
    #Customer details information inside the customer list page
    path('customer/<int:pk>/', views.customerDetail, name='customer_detail'),

    #Interaction details inside customer list page
    ...
    path('attendance_data/<int:year>',views.customer_attendance, name = 'attendance_data'),
